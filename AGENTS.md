...
This file is the quick-reference operating contract for rama-unix-kotlin. The longer
...
rama-unix-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-unix`](https://crates.io/crates/rama-unix). Upstream Rust is the behavioral oracle while the
