# rama-unix-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Frama--unix--kotlin-blue.svg)](https://github.com/KotlinMania/rama-unix-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/rama-unix-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/rama-unix-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/rama-unix-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/rama-unix-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`plabayo/rama`](https://github.com/plabayo/rama).

**Original Project:** This port is based on [`plabayo/rama`](https://github.com/plabayo/rama). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `plabayo/rama`

> The text below is reproduced and lightly edited from [`https://github.com/plabayo/rama`](https://github.com/plabayo/rama). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.

[![rama banner](https://github.com/plabayo/rama/blob/HEAD/docs/img/rama_banner.jpeg)](https://ramaproxy.org/)
...
| ✅ web protocols | ✅ [SSE](https://ramaproxy.org/docs/rama/http/sse/index.html) ⸱ ✅ [Datastar](https://ramaproxy.org/docs/rama/http/sse/datastar/index.html) ⸱ ✅ [WS](https://ramaproxy.org/docs/rama/http/ws/index.html) ⸱ ❌ Web Transport ⸱ ✅ [gRPC](https://ramaproxy.org/docs/rama/http/grpc/index.html) |
...
on real devices, which [uses the public fingerprinting service](https://github.com/plabayo/rama/blob/HEAD/rama-fp/browserstack/main.py) to aid in automated fingerprint collection
...
to [audit our supply chain](https://github.com/plabayo/rama/blob/HEAD/supply-chain/).
...
Special thanks goes to all involved in developing, maintaining and supporting [the Rust programming language](https://www.rust-lang.org/), the [Tokio ecosystem](https://tokio.rs/) and [all other crates](https://github.com/plabayo/rama/blob/HEAD/Cargo.toml) that we depend upon. This also includes [Hyper and its ecosystem](https://github.com/hyperium) as without those projects rama would not be. The core http module of rama is a specialised fork of `hyper` and use the underlying `h2` and `h3` crates as dependencies.
...
[![Plabayo's Store With rama Merchandise](https://github.com/plabayo/rama/blob/HEAD/docs/img/plabayo_mech_store_rama.png)](https://plabayo.threadless.com/)
...
[![original (OG) rama logo](https://github.com/plabayo/rama/blob/HEAD/docs/book/src/img/old_logo.png)](https://ramaproxy.org/)
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:rama-unix-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same MIT license as the upstream [`plabayo/rama`](https://github.com/plabayo/rama). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the rama authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`plabayo/rama`](https://github.com/plabayo/rama) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
