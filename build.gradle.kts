...
kotlin {
    ...
    val xcf = XCFramework("RamaUnix")

    macosArm64 {
        binaries.framework { baseName = "RamaUnix"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RamaUnix"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaUnix"
        flattenPackage = "io.github.kotlinmania.ramaunix"
    }

    android {
        namespace = "io.github.kotlinmania.ramaunix"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-unix-kotlin", version.toString())

    pom {
        name.set("rama-unix-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - Unix (Domain) socket support for rama")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-unix-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-unix-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-unix-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-unix-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRamaUnixXCFramework",
    "assembleRamaUnixDebugXCFramework",
    "assembleRamaUnixReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseIosFatFrameworkForRamaUnixXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRamaUnixXCFramework",
    "assembleDebugMacosFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseMacosFatFrameworkForRamaUnixXCFramework",
    "assembleDebugTvosFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseTvosFatFrameworkForRamaUnixXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRamaUnixXCFramework",
    "assembleDebugWatchosFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseWatchosFatFrameworkForRamaUnixXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRamaUnixXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRamaUnixXCFramework",
