...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RamaUnix.swiftmodule/`
...
//      `import RamaUnix` above would fail at compile time.
//
//   2. The static archive `libRamaUnix.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RamaUnix" }` and
//      `flattenPackage = "io.github.kotlinmania.ramaunix"` configuration in
...
//      via the `RamaUnixLibrary` product.
//
